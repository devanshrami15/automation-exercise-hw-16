...
#        18. Verify that 'ACCOUNT DELETED!' is visible and click 'Continue' button
  ...
  Scenario: User should register successfully
    ...
    And I send name "Dev" and email "Dev" to signup
    And I click on button "Signup"
    Then I should see text "ENTER ACCOUNT INFORMATION"
    And I fill all details in signup page "Mr" "Dev123" "25" "August" "2002" "Dev" "Rami" "Krishna Heights" "Pij Road" "India" "Gujarat" "Nadiad" "387002" "08000987000"
    ...
    Then I should see the text "Logged in as " "Dev"
...
#        8. Verify error 'Email Address already exist!' is visible
  ...
  Scenario: User should see error message while register with existing email
    ...
    When I click on header menu option "Signup / Login"
    Then I should see the login page text "New User Signup!"
    And I send name "Dev" to name field in signup
    And I send email "dev25@gmail.com" to email field in signup
    And I click on button "Signup"
...
#        20. Verify 'ACCOUNT DELETED!' and click 'Continue' button
  ...
  Scenario: User should Place Order: Register while Checkout
    ...
    And I enter payment details "Maitri Rami" "3703582640264416" "542" "07" and "2028"
...
#        17. Verify 'ACCOUNT DELETED!' and click 'Continue' button
  ...
  Scenario: User should place the order successfully : Login before Checkout
    ...
    And I enter "maitri20@gmail.com" email and "Maitri@2015" password for login
...
#        15. Verify 'ACCOUNT DELETED!' and click 'Continue' button
  ...
  Scenario: Verify address details in checkout page
    ...
    And I should see the welcome text on shopping cart page "Shopping Cart"
    And I click on Proceed to Checkout button
    Then I should see the delivery address is same address filled at the time registration of account "Krishna Heights"
    And I should see billing address is same address filled at the time registration of account "Krishna Heights"
    And I click on header menu option "Delete Account"
    Then I should see the account deleted message "ACCOUNT DELETED!"
    And I click on continue button after deleting account
